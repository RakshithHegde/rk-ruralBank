...
export default function Transfer() {
  ...
  const transferMoney = async (e) => {
    ...
    var rusr = posts.filter((p) => {
      return p.email === reciver;
    });
    console.log("sender account:", rusr[0].amount);

    var susr = posts.filter((p) => {
      return p.email === sender;
    });
  ...
  const buttonContents = <React.Fragment>Transfer</React.Fragment>;
        ...
        >
          <Grid item>
            <Typography
              variant="h3"
              align="center"
              style={{ lineHeight: 1, color: "#394867", textAlign: "center" }}
            >
              Transfer Money
            </Typography>
          </Grid>
          <Grid
            ...
            direction="column"
            style={{
              maxWidth: matchesXS ? "20em" : matchesSM ? "25em" : "40em",
            }}
          >
